...
release-ready 상태의 `0.3.0` codec line을 포함합니다.
...
`bluetape-rs-codec` boundary를 추가합니다. URL-safe encoding과 UTF-8
text/byte boundary helper도 이 범위에 포함합니다. Compression, serialization,
Testcontainers, SQL, resilience, leader election package는 dependency 및
runtime 비용을 명시적으로 다루기 위해 별도 milestone에 남겨둡니다.
